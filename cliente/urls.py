...
from .views import ClienteCreateView, ContasReceberDeleteView, ContasReceberListView, ContasReceberUpdateView, FiadoCreateView, lista_fiado, ContasReceberCreateView, codigo_acesso
