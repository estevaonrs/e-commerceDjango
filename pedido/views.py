...
def pagar(request, id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Resto do seu código permanece o mesmo
            asaas = Asaas(access_token='$aact_YTU5YTE0M2M2N2I4MTliNzk0YTI5N2U5MzdjNWZmNDQ6OjAwMDAwMDAwMDAwMDAzNDYwOTk6OiRhYWNoX2M4ZTI2MjdhLTRkYzktNGRkYS1hYzA2LTlmMzRiZTAwYjI1NA==', production=True)
